...
public class Proveedor extends DatosGenerales {
     ...
     * @author oscar.d.rodriguez
     * @see "Constructor de la clase proveedor"
     ...
     */
    public Proveedor( int cveProveedor, String nombre, String apellidoPaterno, String apellidoMaterno, tipoPersona tipoPersona) {
        super(nombre, apellidoPaterno, apellidoMaterno, tipoPersona);
        this.cveProveedor = cveProveedor;
    }

    /**
     * Metodo para recuperar el identificador del proveedor
     * @author oscar.d.rodriguez
    ...
    public double saldo() {
        ...
        return Math.round((importe * 100.0) / 100.0)*-1.00;
    }

    /**
     * Metodo para imprimir la informacion del proveedor
     * @author oscar.d.rodriguez
     * @see "Constructor de la clase proveedor que imprime la informacion del proveedor"
